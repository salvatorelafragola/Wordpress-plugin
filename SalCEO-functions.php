...
if( !defined( ‘make-it-creative-seo’ ) ) {exit();}
...
function mic_get_all_id(){
    $id1= mic_getid_by_shortcode('[makeitseo-keyword]');
    $id2= mic_getid_by_shortcode('[makeitseo-keyword-secteur]');
    $id3= mic_getid_by_shortcode('[makeitseo-services]');
    $id4= mic_getid_by_shortcode('[makeitseo-secteur]');
    $id5= mic_getid_by_shortcode('[makeitseo-keyword-id]');
    $id6= mic_getid_by_shortcode('[makeitseo-service]');
    $id7= mic_getid_by_shortcode('[makeitseo-article]');
